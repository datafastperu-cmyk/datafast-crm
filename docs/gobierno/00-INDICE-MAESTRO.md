...
| **E-0.2** | Modelo de Información del Core — Cliente, Contrato, Cuenta, Servicio Contratado | ✅ **Vigente** v2.5 | [E-0.2-modelo-informacion-core.md](E-0.2-modelo-informacion-core.md) |
...
| **F-0.1-A** | **Catálogo de comprobaciones** — los 50 invariantes con su mecanismo | Vigente v1.3 | [F-0.1-anexo-catalogo-comprobaciones.md](F-0.1-anexo-catalogo-comprobaciones.md) |
