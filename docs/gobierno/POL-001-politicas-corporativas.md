...
| **B — riesgo técnico** | **11** | **4** — B-9 **retirada: nunca existió** · B-12 y B-13 (07/08) · **B-14 (08/08)**. Dos nuevas: **B-15**, con su prerrequisito resuelto, y **B-16** (16/08, Ola 0 — causa puntual y silencio ya corregidos, falta el test de regresión) | Arquitecto · **B-15 escala al propietario** | Con condición de cierre declarada |
