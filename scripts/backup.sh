#!/bin/bash
# ==============================================================
# FibraNet ISP — Backup automático PostgreSQL
# Cron sugerido: 0 2 * * * /opt/fibranet/scripts/backup.sh
...
# Configuración
BACKUP_DIR="/opt/fibranet/backups"
RETENTION_DAYS=30
DATE=$(date +%Y%m%d_%H%M%S)
FILENAME="fibranet_${DATE}.sql.gz"
LOG_FILE="/opt/fibranet/logs/backup.log"
...
DELETED=$(find "$BACKUP_DIR" -name "fibranet_*.sql.gz" -mtime +$RETENTION_DAYS -delete -print | wc -l)
