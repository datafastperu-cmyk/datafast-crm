...
// LLAMAR, que era la que contaba — con el módulo global desde el 28/07, de 47 crons latían
// 10. `CronLatidoService` cierra el hueco haciendo el latido automático para todo lo que
