  ...
  imports: [
    ...
    TypeOrmModule.forRootAsync({
      ...
      useFactory: (config: ConfigService) => ({
        ...
        migrationsRun: config.get('app.env') === 'production',
        synchronize: false,
        logging: config.get('app.env') === 'development' ? ['query', 'error', 'warn'] : ['error', 'warn'],
        extra: { max: 20, min: 2, idleTimeoutMillis: 30000, statement_timeout: 30000 },
        retryAttempts: 10,
        retryDelay: 3000,
