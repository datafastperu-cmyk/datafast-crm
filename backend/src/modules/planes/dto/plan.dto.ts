...
export class CreatePlanDto {
  ...
  @ApiProperty({ example:30 }) @IsInt() @Min(1) @Max(10000) @Type(()=>Number) velocidadBajada: number;
  @ApiProperty({ example:15 }) @IsInt() @Min(1) @Max(10000) @Type(()=>Number) velocidadSubida: number;
  @ApiPropertyOptional() @IsOptional() @IsInt() @Min(1) @Type(()=>Number) burstBajada?: number;
  @ApiPropertyOptional() @IsOptional() @IsInt() @Min(1) @Type(()=>Number) burstSubida?: number;
