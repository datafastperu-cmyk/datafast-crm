...
// ─────────────────────────────────────────────────────────────
// Migración 005 — Routers Mikrotik y Antenas/Nodos WISP
// Equipos de red monitoreados por el sistema.
// ─────────────────────────────────────────────────────────────
export class CreateRoutersAndNodos1700000005000 implements MigrationInterface {
  name = 'CreateRoutersAndNodos1700000005000';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    // ── HISTORIAL DE MONITOREO (mediciones) ───────────────────
    await queryRunner.query(`
    ...
    // Particionamiento por tiempo para manejar millones de mediciones
    await queryRunner.query(`
