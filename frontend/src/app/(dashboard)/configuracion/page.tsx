...
const CATEGORIES = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/configuracion/sistema',  label: 'Sistema',            icon: Monitor,  desc: 'Versión del ERP, actualizaciones y registro de eventos' },
      { href: '/configuracion/servidor', label: 'Servidor',           icon: Server,   desc: 'Recursos y procesos de la VPS (RAM, disco, PM2)' },
