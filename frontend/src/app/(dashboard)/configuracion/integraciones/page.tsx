...
const INTEGRATIONS = [
  ...
  },
  {
    ...
    description: 'Notificaciones y mensajería masiva',
    href:        '/configuracion/mensajeria-config',
    badge:       'Configurar',
    badgeCls:    'bg-green-500/10 text-green-600',
    logo:        'W',
    logoCls:     'bg-green-500/10 text-green-600',
  },
  {
    id:          'mikrotik',
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-xs text-muted-foreground">
            Conecta servicios externos con tu CRM
          </p>
        </div>
      </div>
