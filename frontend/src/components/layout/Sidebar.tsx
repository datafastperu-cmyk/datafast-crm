...
const NAV: NavEntry[] = [
...

  {
    ...
    items: [
      ...
      { href: '/mensajeria/whatsapp',   label: 'CRM WhatsApp',      icon: MessageSquare, permiso: null },
      { href: '/mensajeria/campanas',   label: 'Campañas Masivas',  icon: Megaphone,     permiso: null },
    ],
  },
