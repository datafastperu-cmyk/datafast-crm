...
export const mockNodos = [
  ...
  { id:'n11', nombre: 'ACCESS-VMT-02',     tipo: 'router', ipMonitoreo: '10.0.11.1',  estado: 'offline',  latenciaMs: null,perdidaPct: 100, cpuUsoPct: 0,  memoriaUsoPct: 0,  traficoRxBps: 0,           traficoTxBps: 0,           sesionesPppoe: 0,   ultimoPing: new Date(Date.now() - 3600000).toISOString() },
  { id:'n12', nombre: 'ACCESS-ATE-02',     tipo: 'router', ipMonitoreo: '10.0.12.1',  estado: 'offline',  latenciaMs: null,perdidaPct: 100, cpuUsoPct: 0,  memoriaUsoPct: 0,  traficoRxBps: 0,           traficoTxBps: 0,           sesionesPppoe: 0,   ultimoPing: new Date(Date.now() - 1800000).toISOString() },
] as const;
